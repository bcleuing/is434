...
function renderCharts(formattedStat, totalFans) {
    ...
    for (var genderKey in formattedStat) {
        ...
        statChartsHTML += '<a href="#" class="waves-light waves-effect btn-large" download="fan-' + genderKey + '.png">';
    ...
    $('#pagesFanInfoCharts').append(
        ...
        '<a href="#" class="waves-light waves-effect btn-large" download="number-of-fans-overall.png">' +
